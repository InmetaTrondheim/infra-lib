...
resource "azurerm_log_analytics_workspace" "core_log_analytics" {
  name                = "core-log-analytics-${var.core.project_name}-${var.core.environment}"
...
resource "azurerm_monitor_action_group" "core_action_group" {
  name                = "core-action-group-${var.core.project_name}-${var.core.environment}"
  resource_group_name = var.core.rg.name
  short_name          = var.core.project_name
